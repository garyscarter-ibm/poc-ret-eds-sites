...
function getSocialIcon(text) {
  ...
  return match ? SOCIAL_ICONS[match] : null;
}
...
export default function decorate(block) {
  [...block.children].forEach((row) => {
    ...
    // Detect social links card (has 3+ link divs)
  ...
  block.querySelectorAll('a:not(.social-card a)').forEach((a) => {

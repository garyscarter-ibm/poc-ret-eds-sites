const MODELS = {
  x7: {
    name: 'X7',
    image: 'https://range-comparator.s3.amazonaws.com/uploads/scaled_image/20231109155036440489/G07%20-%20Side.png',
    length: 5181,
    height: 1835,
    doors: 5,
  },
  xm: {
    name: 'XM',
    image: 'https://range-comparator.s3.amazonaws.com/uploads/scaled_image/20221114072836171917/G09_XM%20Cape%20York%20Green%20Metallic%20sideview.png',
    length: 5110,
    height: 1755,
    doors: 5,
  },
...
export default async function decorate(block) {
  ...
  selector.querySelectorAll('.comparator-dim-btn').forEach((btn) => {
    btn.addEventListener('click', () => {
      selector.querySelectorAll('.comparator-dim-btn').forEach((b) => b.classList.remove('active'));

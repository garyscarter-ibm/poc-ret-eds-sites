...
export default async function decorate(block) {
  ...
  try {
    ...
    skeleton.replaceWith(
      el('div', 'vg-error', `<p>Unable to load your garage. Please try again later.</p><p class="vg-error-detail">${err.message}</p>`),
    );
  }
}
